...
function MenuLeft () {
    ...
    return (
        <aside className={`${isContentOpen && 'md:w-66 w-full'} h-full pt-8 pb-8 pr-4 pl-4 border-r border-gray-300 relative`}>
            <FontAwesomeIcon 
                className={`${isContentOpen ? 'right-[-15px] md:right-[-6%]' : 'md:right-[-48%]'} absolute text-gray-50 bg-gray-400 p-1 rounded-3xl text-lg cursor-pointer`}
                icon={faBurger} 
